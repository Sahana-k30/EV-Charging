...
router.get('/page', (req, res) => {
    ...
    res.render('payments/index', { title: 'Payments', payments, demo: true });
});
...
router.get('/demo/:id', (req, res) => {
    ...
    res.render('payments/details', { payment });
});
...
router.get('/:id', protect, async (req, res) => {
    try {
        ...
        if (req.xhr) {
            ...
            req.flash('error_msg', 'Error fetching payment details');
...
router.get('/analysis', protect, async (req, res) => {
    try {
        ...
        // Convert top stations to sorted array
        ...
        if (req.xhr) {
            ...
            req.flash('error_msg', 'Error generating payment analysis');
            res.redirect('/dashboard');
        }
    }
});
...
router.get('/:id/receipt', protect, async (req, res) => {
    try {
        ...
        // Generate receipt (implementation depends on your receipt generation library)
